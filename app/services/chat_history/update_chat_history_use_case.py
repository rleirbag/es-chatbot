...
class UpdateChatHistoryUseCase:
    @staticmethod
    @commit
    def execute(db: Session, chat_history_id: int, chat_history_update, user_email: str):
        ...
        chat_history, error = update(db, ChatHistory, chat_history_id, chat_history_update)
        if error:
            return None, error
